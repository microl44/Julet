...
function PrintMovies()
{
    ...
    // $descriptions = $conn->query("SELECT  from movieDescription ORDER BY movieID;");
...
{
  $quotes = array("Nu är det hjul igen, o nu är det hjul igen, o hjulen varar fram till kl elva", 
    "Antman 2 är hot garbage", "Any similarities to real holidays is purely coincidental.", 
    "The better jul", 
    "Seeing the 4th movie first should be illegal", 
    "I have a dream, that a movie shall not be judged by the image on the cover, but by the content of the story!",
    "Höhöhö sån färg borde man ha", 
    "Linus vinner alltid", 
    "Linus vinner aldrig", 
    "I created Ultron, and I'd do it again!", 
    "It's the ballot or the wheel!", 
    "The greatest trick the devil played was making humans believe the wheel wasn't rigged", 
    "The wheel is probably not rigged. Probably...",
    "It is during our darkest moments that we must focus to see the light", 
    "Thanos should've won", 
    "Yeah Spider-Man was great and all but have you seen Black Widow?",
    "Om en funktion saknas så var det helt enkelt en fråga om prioriteringar", 
    "Do you think god stays in heaven because he too lives in fear of what he's created?", 
    "It's like printing my own money!",
    "i volunteer as tribute!", 
    "Screaming goats are fucking hillarious!", 
    "The council will decide on your fate", 
    "I hearby sentence you to eternal damnation!", 
    "Gentlemen, it's with great pleasure to imform you that I just won the wheel", 
    "Allt är Henriks fel!", 
    "REEEEEEEEEEEEEEEEEEEEEE", 
    "Gabbe köp en riktig säng för fan!",
    "Where is the server goblin when you need him?", 
    "Bro It's like gambling but I literally can't lose!", 
    "Du är för dålig för att snurra hjul",
    "Ant-Man could've easily defated Thanos if he just jumped int-", 
    "Because that's what heroes do", "do you know how much I've sacrificed!?",
    "Fun Isn’t Something One Considers When programming in JavaScript. But This… Does Put A Smile On My Face.", 
    "I'm a survivor", 
    "Asså, vi har ett alvarligt problem!", 
    "Eyy Behrad, kör Fallout: New Vegas DLC istället för att sitta här", 
    "I think I'm gonna die out here", 
    "Due to budget cuts we must band together, as a family, and reallocate all profits to my bank account", 
    "Imagine att spendera 180kr för att se Ant-Man 2 på bio HÖHÖHÖ", 
    "A constant? Of course it is, I haven't touched it yet",
    "BRUH", 
    "Hjulen på bussen de går runt runt runt, runt runt run-Ahmen vafan, Linus! Det är något fel på hjulet!",
    "Please don't touch anything. Code displayed is fragile and will disintegrate on touch.", 
    "Bugs are to be expected. On finding any bug-free functionality, please immediately contact an admin for correction.", 
    "All bugs are welcome. Except spiders, but only because they're arachnoids and not bugs.", 
    "Please only use SQL injections for good purposes", 
    "Fucking magnets, how do they work?", "Battle not with monsters, lest ye become a monster, and if you gaze into JavaScript, the JavaScript gazes also into you", 
    "I write HTML, therefore I ain't", 
    "Why use margin when <\br><\br><\br><\br><\br><\br><\br><\br><\br><\br><\br> do trick?",
    "If only I had a website that could depict movie stats and 100 random quotes at the same time...", 
    "See, marvel movies are like Onions. Each layer... Wait, why's there only 1 layer?", 
    "We sped up the natural cycle of life and death! We gave these two suckers a shortcut!",
    "Fuck that 8 year old, she's a fucking bitch", 
    "AI written code sounds cool, until you realize it's responsible for breaking this website every week", 
    "DNA is just compiled protein-code",
    "Don't mind your PC lifting, it's just the bitcoin-miner doing what it's supposed to.", 
    "The wheel giveth, the wheel taketh. However, for some it seems it's mostly taketh",
    ...
    "Lord of the rings is dumb, they could've just taken the eagles to mordor", 
    "There's always another after-credits scene", 
    "Looking for front-end develops capable of centering a div. Please send an email if this applies to you", 
    "The syntax is more what you'd call guidelines than actual rules",
    "I got a <s>jar</s> repo of dirt, I got a <s>jar</s> repo of dirt!", 
    "Did you know that evehaup916adskasyjk BELLA NER FRÅN TANGENTBORDET! HDSFJJ",
    "So long, and thanks for all the fish!", 
    "Hörru, du har inte tid att kolla på film, du har skolarbete att göra.", 
    "We didn't invent the wheel, we just perfected it",
    ...
    "Don't use a wheel to determine what's for dinner", 
    "The greatest glory lies not in never failing, but to see shawshank redemtion lose to the bee movie.",
    "Do you feel lucky, punk?", 
    "You might not have won, but you've instead learned a valuable lesson in losing with grace.", 
    "Holy shit, what an amazing website! Fuck it this is mine now", 
    "Any web-scraping you find is approved by imdb. No need to contact them about it, I swear",
    "There's good movies within every category. Yes, even Sports", 
    "You miss 100% of the movies you don't bring to the wheel", 
    ...
    "We might watch together, but we will always spin alone", 
    "I pity the fool that hasn't won yet!", 
    "Cult is an ugly word, I preffer 'up-and-coming religion'",
    "Guess you could call Tarantino movies a 'cult-classic' around here", 
    "I'd rather shit myself than join the army", 
    "Brooks was here", 
    "Arcane is NOT an anime", 
    "Mr Behrad, I don't feel so good", 
    "Hey, did the toys in that kids movie just embrace death?", 
    "You have your mothers <s>eyes</s> shit taste in movies", 
    "Now with working hash function!",
    "Please keep any tears away from the wheel", 
    "Say 'Hello' to my little wheel!", 
    "I love the smell of napalm in the morning", 
    "We're gonna need a bigger wheel",
    "Any desired feature suggestions should be translated into monkey-speak and sent tobeviseta@gmail.com", 
    "The needs of the wheel outweighs the needs of the many", 
    "Seek Wheel, the rest will follow", 
    "Watching movies with friends is a sign of a good time. Creating a website about movies you watch is a sign of a wasted life",
    "Bohemian Rhapsody is the greatest guns n roses song ever", 
    "I'm tired boss, dog tired...", 
    "Stop using memes, it's pissing me off!", 
    "Here's to the new us!",
    "Any storing of IP, username, pages viewed, bank pin and name of first born is purely for security reasons");

  $quotees = array("Abraham Lincoln", 
    "Winston Churchill", 
  ...
  else if($randomQuote == "Here's to the new us!")
  {
    $randomQuotee = "Micke, till Behrad innan ändringar i databasen";
  }
